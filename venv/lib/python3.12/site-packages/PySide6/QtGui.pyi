...
class QNativeInterface(Shiboken.Object):
    ...
    class QWaylandApplication(Shiboken.Object):

        def __init__(self, /) -> None: ...

        def compositor(self, /) -> int: ...
        def display(self, /) -> int: ...
        def keyboard(self, /) -> int: ...
        def lastInputSeat(self, /) -> int: ...
        def lastInputSerial(self, /) -> int: ...
...
class QRhiCommandBuffer(PySide6.QtGui.QRhiResource):
    ...
    def setShaderResources(self, /, srb: PySide6.QtGui.QRhiShaderResourceBindings | None = ..., dynamicOffsetCount: int | None = ..., dynamicOffsets: typing.Tuple[int, int] | None = ...) -> None: ...
