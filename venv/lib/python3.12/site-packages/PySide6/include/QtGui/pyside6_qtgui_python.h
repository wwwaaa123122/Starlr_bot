...
enum [[deprecated]] : int {
    ...
    SBK_QFONT_HINTINGPREFERENCE_IDX                          = 974,
    ...
    SBK_QNATIVEINTERFACE_QWAYLANDAPPLICATION_IDX             = 394,
    SBK_QNATIVEINTERFACE_QX11APPLICATION_IDX                 = 398,
    ...
    SBK_QRHIDEPTHSTENCILCLEARVALUE_IDX                       = 598,
    SBK_QRHIDRIVERINFO_DEVICETYPE_IDX                        = 602,
    SBK_QRHIDRIVERINFO_IDX                                   = 600,
    SBK_QRHIGLES2INITPARAMS_IDX                              = 604,
    SBK_QRHIGLES2NATIVEHANDLES_IDX                           = 606,
    SBK_QRHIGRAPHICSPIPELINE_FLAG_IDX                        = 620,
    SBK_QFLAGS_QRHIGRAPHICSPIPELINE_FLAG_IDX                 = 202,
    SBK_QRHIGRAPHICSPIPELINE_TOPOLOGY_IDX                    = 632,
    SBK_QRHIGRAPHICSPIPELINE_CULLMODE_IDX                    = 618,
    SBK_QRHIGRAPHICSPIPELINE_FRONTFACE_IDX                   = 622,
    SBK_QRHIGRAPHICSPIPELINE_COLORMASKCOMPONENT_IDX          = 614,
    SBK_QFLAGS_QRHIGRAPHICSPIPELINE_COLORMASKCOMPONENT_IDX   = 200,
    SBK_QRHIGRAPHICSPIPELINE_BLENDFACTOR_IDX                 = 610,
    SBK_QRHIGRAPHICSPIPELINE_BLENDOP_IDX                     = 612,
    SBK_QRHIGRAPHICSPIPELINE_COMPAREOP_IDX                   = 616,
    SBK_QRHIGRAPHICSPIPELINE_STENCILOP_IDX                   = 626,
    SBK_QRHIGRAPHICSPIPELINE_POLYGONMODE_IDX                 = 624,
    SBK_QRHIGRAPHICSPIPELINE_IDX                             = 608,
    SBK_QRHIGRAPHICSPIPELINE_STENCILOPSTATE_IDX              = 628,
    SBK_QRHIGRAPHICSPIPELINE_TARGETBLEND_IDX                 = 630,
    SBK_QRHIINITPARAMS_IDX                                   = 634,
    SBK_QRHINATIVEHANDLES_IDX                                = 636,
    SBK_QRHINULLINITPARAMS_IDX                               = 638,
    SBK_QRHIREADBACKDESCRIPTION_IDX                          = 640,
    SBK_QRHIREADBACKRESULT_IDX                               = 642,
    SBK_QRHIRENDERBUFFER_TYPE_IDX                            = 648,
    SBK_QRHIRENDERBUFFER_FLAG_IDX                            = 646,
    SBK_QFLAGS_QRHIRENDERBUFFER_FLAG_IDX                     = 204,
    SBK_QRHIRENDERBUFFER_IDX                                 = 644,
    SBK_QRHIRENDERPASSDESCRIPTOR_IDX                         = 650,
    SBK_QRHIRENDERTARGET_IDX                                 = 652,
    SBK_QRHIRESOURCE_TYPE_IDX                                = 656,
    SBK_QRHIRESOURCE_IDX                                     = 654,
    SBK_QRHIRESOURCEUPDATEBATCH_IDX                          = 658,
    SBK_QRHISAMPLER_FILTER_IDX                               = 666,
    SBK_QRHISAMPLER_ADDRESSMODE_IDX                          = 662,
    SBK_QRHISAMPLER_COMPAREOP_IDX                            = 664,
    SBK_QRHISAMPLER_IDX                                      = 660,
    SBK_QRHISCISSOR_IDX                                      = 668,
    SBK_QRHISHADERRESOURCEBINDING_TYPE_IDX                   = 682,
    SBK_QRHISHADERRESOURCEBINDING_STAGEFLAG_IDX              = 678,
    SBK_QFLAGS_QRHISHADERRESOURCEBINDING_STAGEFLAG_IDX       = 206,
    SBK_QRHISHADERRESOURCEBINDING_IDX                        = 670,
    SBK_QRHISHADERRESOURCEBINDING_DATA_IDX                   = 672,
    SBK_QRHISHADERRESOURCEBINDING_DATA_STORAGEBUFFERDATA_IDX = 674,
    SBK_QRHISHADERRESOURCEBINDING_DATA_STORAGEIMAGEDATA_IDX  = 676,
    SBK_QRHISHADERRESOURCEBINDING_TEXTUREANDSAMPLER_IDX      = 680,
    SBK_QRHISHADERRESOURCEBINDINGS_UPDATEFLAG_IDX            = 686,
    SBK_QFLAGS_QRHISHADERRESOURCEBINDINGS_UPDATEFLAG_IDX     = 208,
    SBK_QRHISHADERRESOURCEBINDINGS_IDX                       = 684,
    SBK_QRHISHADERSTAGE_TYPE_IDX                             = 690,
    SBK_QRHISHADERSTAGE_IDX                                  = 688,
    SBK_QRHISTATS_IDX                                        = 692,
    SBK_QRHISWAPCHAIN_FLAG_IDX                               = 696,
    SBK_QFLAGS_QRHISWAPCHAIN_FLAG_IDX                        = 210,
    SBK_QRHISWAPCHAIN_FORMAT_IDX                             = 698,
    SBK_QRHISWAPCHAIN_STEREOTARGETBUFFER_IDX                 = 700,
    SBK_QRHISWAPCHAIN_IDX                                    = 694,
    SBK_QRHISWAPCHAINRENDERTARGET_IDX                        = 702,
    SBK_QRHITEXTURE_FLAG_IDX                                 = 706,
    SBK_QFLAGS_QRHITEXTURE_FLAG_IDX                          = 212,
    SBK_QRHITEXTURE_FORMAT_IDX                               = 708,
    SBK_QRHITEXTURE_IDX                                      = 704,
    SBK_QRHITEXTURE_VIEWFORMAT_IDX                           = 710,
    SBK_QRHITEXTURECOPYDESCRIPTION_IDX                       = 712,
    SBK_QRHITEXTURERENDERTARGET_FLAG_IDX                     = 716,
    SBK_QFLAGS_QRHITEXTURERENDERTARGET_FLAG_IDX              = 214,
    SBK_QRHITEXTURERENDERTARGET_IDX                          = 714,
    SBK_QRHITEXTURERENDERTARGETDESCRIPTION_IDX               = 718,
    SBK_QRHITEXTURESUBRESOURCEUPLOADDESCRIPTION_IDX          = 720,
    SBK_QRHITEXTUREUPLOADDESCRIPTION_IDX                     = 722,
    SBK_QRHITEXTUREUPLOADENTRY_IDX                           = 724,
    SBK_QRHIVERTEXINPUTATTRIBUTE_FORMAT_IDX                  = 728,
    SBK_QRHIVERTEXINPUTATTRIBUTE_IDX                         = 726,
    SBK_QRHIVERTEXINPUTBINDING_CLASSIFICATION_IDX            = 732,
    SBK_QRHIVERTEXINPUTBINDING_IDX                           = 730,
    SBK_QRHIVERTEXINPUTLAYOUT_IDX                            = 734,
    SBK_QRHIVIEWPORT_IDX                                     = 736,
    SBK_QSCREEN_IDX                                          = 738,
    SBK_QSCROLLEVENT_SCROLLSTATE_IDX                         = 742,
    SBK_QSCROLLEVENT_IDX                                     = 740,
    SBK_QSCROLLPREPAREEVENT_IDX                              = 744,
    SBK_QSESSIONMANAGER_RESTARTHINT_IDX                      = 748,
    SBK_QSESSIONMANAGER_IDX                                  = 746,
    SBK_QSHADER_STAGE_IDX                                    = 756,
    SBK_QSHADER_SOURCE_IDX                                   = 754,
    SBK_QSHADER_VARIANT_IDX                                  = 758,
    SBK_QSHADER_SERIALIZEDFORMATVERSION_IDX                  = 752,
    SBK_QSHADER_IDX                                          = 750,
    SBK_QSHADERCODE_IDX                                      = 760,
    SBK_QSHADERKEY_IDX                                       = 762,
    SBK_QSHADERVERSION_FLAG_IDX                              = 766,
    SBK_QFLAGS_QSHADERVERSION_FLAG_IDX                       = 216,
    SBK_QSHADERVERSION_IDX                                   = 764,
    SBK_QSHORTCUT_IDX                                        = 768,
    SBK_QSHORTCUTEVENT_IDX                                   = 770,
    SBK_QSHOWEVENT_IDX                                       = 772,
    SBK_QSINGLEPOINTEVENT_IDX                                = 774,
    SBK_QSTANDARDITEM_ITEMTYPE_IDX                           = 778,
    SBK_QSTANDARDITEM_IDX                                    = 776,
    SBK_QSTANDARDITEMMODEL_IDX                               = 780,
    SBK_QSTATICTEXT_PERFORMANCEHINT_IDX                      = 784,
    SBK_QSTATICTEXT_IDX                                      = 782,
    SBK_QSTATUSTIPEVENT_IDX                                  = 786,
    SBK_QSTYLEHINTS_IDX                                      = 788,
    SBK_QSURFACE_SURFACECLASS_IDX                            = 792,
    SBK_QSURFACE_SURFACETYPE_IDX                             = 794,
    SBK_QSURFACE_IDX                                         = 790,
    SBK_QSURFACEFORMAT_FORMATOPTION_IDX                      = 800,
    SBK_QFLAGS_QSURFACEFORMAT_FORMATOPTION_IDX               = 218,
    SBK_QSURFACEFORMAT_SWAPBEHAVIOR_IDX                      = 806,
    SBK_QSURFACEFORMAT_RENDERABLETYPE_IDX                    = 804,
    SBK_QSURFACEFORMAT_OPENGLCONTEXTPROFILE_IDX              = 802,
    SBK_QSURFACEFORMAT_COLORSPACE_IDX                        = 798,
    SBK_QSURFACEFORMAT_IDX                                   = 796,
    SBK_QSYNTAXHIGHLIGHTER_IDX                               = 808,
    SBK_QTABLETEVENT_IDX                                     = 810,
    SBK_QTEXTBLOCK_IDX                                       = 812,
    SBK_QTEXTBLOCK_ITERATOR_IDX                              = 814,
    SBK_QTEXTBLOCKFORMAT_LINEHEIGHTTYPES_IDX                 = 976,
    SBK_QTEXTBLOCKFORMAT_MARKERTYPE_IDX                      = 818,
    SBK_QTEXTBLOCKFORMAT_IDX                                 = 816,
    SBK_QTEXTBLOCKGROUP_IDX                                  = 820,
    SBK_QTEXTBLOCKUSERDATA_IDX                               = 822,
    SBK_QTEXTCHARFORMAT_VERTICALALIGNMENT_IDX                = 830,
    SBK_QTEXTCHARFORMAT_UNDERLINESTYLE_IDX                   = 828,
    SBK_QTEXTCHARFORMAT_FONTPROPERTIESINHERITANCEBEHAVIOR_IDX = 826,
    SBK_QTEXTCHARFORMAT_IDX                                  = 824,
    SBK_QTEXTCURSOR_MOVEMODE_IDX                             = 834,
    SBK_QTEXTCURSOR_MOVEOPERATION_IDX                        = 836,
    SBK_QTEXTCURSOR_SELECTIONTYPE_IDX                        = 838,
    SBK_QTEXTCURSOR_IDX                                      = 832,
    SBK_QTEXTDOCUMENT_METAINFORMATION_IDX                    = 846,
    SBK_QTEXTDOCUMENT_MARKDOWNFEATURE_IDX                    = 844,
    SBK_QFLAGS_QTEXTDOCUMENT_MARKDOWNFEATURE_IDX             = 222,
    SBK_QTEXTDOCUMENT_FINDFLAG_IDX                           = 842,
    SBK_QFLAGS_QTEXTDOCUMENT_FINDFLAG_IDX                    = 220,
    SBK_QTEXTDOCUMENT_RESOURCETYPE_IDX                       = 848,
    SBK_QTEXTDOCUMENT_STACKS_IDX                             = 850,
    SBK_QTEXTDOCUMENT_IDX                                    = 840,
    SBK_QTEXTDOCUMENTFRAGMENT_IDX                            = 852,
    SBK_QTEXTDOCUMENTWRITER_IDX                              = 854,
    SBK_QTEXTFORMAT_FORMATTYPE_IDX                           = 858,
    SBK_QTEXTFORMAT_PROPERTY_IDX                             = 864,
    SBK_QTEXTFORMAT_OBJECTTYPES_IDX                          = 860,
    SBK_QTEXTFORMAT_PAGEBREAKFLAG_IDX                        = 862,
    SBK_QFLAGS_QTEXTFORMAT_PAGEBREAKFLAG_IDX                 = 224,
    SBK_QTEXTFORMAT_IDX                                      = 856,
    SBK_QTEXTFRAGMENT_IDX                                    = 866,
    SBK_QTEXTFRAME_IDX                                       = 868,
    SBK_QTEXTFRAME_ITERATOR_IDX                              = 870,
    SBK_QTEXTFRAMEFORMAT_POSITION_IDX                        = 876,
    SBK_QTEXTFRAMEFORMAT_BORDERSTYLE_IDX                     = 874,
    SBK_QTEXTFRAMEFORMAT_IDX                                 = 872,
    SBK_QTEXTIMAGEFORMAT_IDX                                 = 878,
    SBK_QTEXTINLINEOBJECT_IDX                                = 880,
    SBK_QTEXTITEM_RENDERFLAG_IDX                             = 884,
    SBK_QFLAGS_QTEXTITEM_RENDERFLAG_IDX                      = 226,
    SBK_QTEXTITEM_IDX                                        = 882,
    SBK_QTEXTLAYOUT_GLYPHRUNRETRIEVALFLAG_IDX                = 892,
    SBK_QFLAGS_QTEXTLAYOUT_GLYPHRUNRETRIEVALFLAG_IDX         = 228,
    SBK_QTEXTLAYOUT_CURSORMODE_IDX                           = 888,
    SBK_QTEXTLAYOUT_IDX                                      = 886,
    SBK_QTEXTLAYOUT_FORMATRANGE_IDX                          = 890,
    SBK_QTEXTLENGTH_TYPE_IDX                                 = 896,
    SBK_QTEXTLENGTH_IDX                                      = 894,
    SBK_QTEXTLINE_EDGE_IDX                                   = 902,
    SBK_QTEXTLINE_CURSORPOSITION_IDX                         = 900,
    SBK_QTEXTLINE_IDX                                        = 898,
    SBK_QTEXTLIST_IDX                                        = 904,
    SBK_QTEXTLISTFORMAT_STYLE_IDX                            = 908,
    SBK_QTEXTLISTFORMAT_IDX                                  = 906,
    SBK_QTEXTOBJECT_IDX                                      = 910,
    SBK_QTEXTOBJECTINTERFACE_IDX                             = 912,
    SBK_QTEXTOPTION_TABTYPE_IDX                              = 920,
    SBK_QTEXTOPTION_WRAPMODE_IDX                             = 922,
    SBK_QTEXTOPTION_FLAG_IDX                                 = 916,
    SBK_QFLAGS_QTEXTOPTION_FLAG_IDX                          = 230,
    SBK_QTEXTOPTION_IDX                                      = 914,
    SBK_QTEXTOPTION_TAB_IDX                                  = 918,
    SBK_QTEXTTABLE_IDX                                       = 924,
    SBK_QTEXTTABLECELL_IDX                                   = 926,
    SBK_QTEXTTABLECELLFORMAT_IDX                             = 928,
    SBK_QTEXTTABLEFORMAT_IDX                                 = 930,
    SBK_QTOOLBARCHANGEEVENT_IDX                              = 932,
    SBK_QTOUCHEVENT_IDX                                      = 934,
    SBK_QTRANSFORM_TRANSFORMATIONTYPE_IDX                    = 938,
    SBK_QTRANSFORM_IDX                                       = 936,
    SBK_QUNDOCOMMAND_IDX                                     = 940,
    SBK_QUNDOGROUP_IDX                                       = 942,
    SBK_QUNDOSTACK_IDX                                       = 944,
    SBK_QVALIDATOR_STATE_IDX                                 = 948,
    SBK_QVALIDATOR_IDX                                       = 946,
    SBK_QVECTOR2D_IDX                                        = 950,
    SBK_QVECTOR3D_IDX                                        = 952,
    SBK_QVECTOR4D_IDX                                        = 954,
    SBK_QWHATSTHISCLICKEDEVENT_IDX                           = 956,
    SBK_QWHEELEVENT_IDX                                      = 958,
    SBK_QWINDOW_VISIBILITY_IDX                               = 964,
    SBK_QWINDOW_ANCESTORMODE_IDX                             = 962,
    SBK_QWINDOW_IDX                                          = 960,
    SBK_QWINDOWSTATECHANGEEVENT_IDX                          = 966,
    SBK_QTGUIQT_IDX                                          = 968,
    SBK_QTGUIHELPER_QOVERRIDECURSORGUARD_IDX                 = 972,
    SBK_QTGUI_IDX_COUNT                                      = 978,
};
...
enum : int {
    ...
    SBK_QFont_HintingPreference_IDX                          = 487,
    ...
    SBK_QNativeInterface_QWaylandApplication_IDX             = 197,
    SBK_QNativeInterface_QX11Application_IDX                 = 199,
    ...
    SBK_QRhiDepthStencilClearValue_IDX                       = 299,
    SBK_QRhiDriverInfo_DeviceType_IDX                        = 301,
    SBK_QRhiDriverInfo_IDX                                   = 300,
    SBK_QRhiGles2InitParams_IDX                              = 302,
    SBK_QRhiGles2NativeHandles_IDX                           = 303,
    SBK_QRhiGraphicsPipeline_Flag_IDX                        = 310,
    SBK_QFlags_QRhiGraphicsPipeline_Flag_IDX                 = 101,
    SBK_QRhiGraphicsPipeline_Topology_IDX                    = 316,
    SBK_QRhiGraphicsPipeline_CullMode_IDX                    = 309,
    SBK_QRhiGraphicsPipeline_FrontFace_IDX                   = 311,
    SBK_QRhiGraphicsPipeline_ColorMaskComponent_IDX          = 307,
    SBK_QFlags_QRhiGraphicsPipeline_ColorMaskComponent_IDX   = 100,
    SBK_QRhiGraphicsPipeline_BlendFactor_IDX                 = 305,
    SBK_QRhiGraphicsPipeline_BlendOp_IDX                     = 306,
    SBK_QRhiGraphicsPipeline_CompareOp_IDX                   = 308,
    SBK_QRhiGraphicsPipeline_StencilOp_IDX                   = 313,
    SBK_QRhiGraphicsPipeline_PolygonMode_IDX                 = 312,
    SBK_QRhiGraphicsPipeline_IDX                             = 304,
    SBK_QRhiGraphicsPipeline_StencilOpState_IDX              = 314,
    SBK_QRhiGraphicsPipeline_TargetBlend_IDX                 = 315,
    SBK_QRhiInitParams_IDX                                   = 317,
    SBK_QRhiNativeHandles_IDX                                = 318,
    SBK_QRhiNullInitParams_IDX                               = 319,
    SBK_QRhiReadbackDescription_IDX                          = 320,
    SBK_QRhiReadbackResult_IDX                               = 321,
    SBK_QRhiRenderBuffer_Type_IDX                            = 324,
    SBK_QRhiRenderBuffer_Flag_IDX                            = 323,
    SBK_QFlags_QRhiRenderBuffer_Flag_IDX                     = 102,
    SBK_QRhiRenderBuffer_IDX                                 = 322,
    SBK_QRhiRenderPassDescriptor_IDX                         = 325,
    SBK_QRhiRenderTarget_IDX                                 = 326,
    SBK_QRhiResource_Type_IDX                                = 328,
    SBK_QRhiResource_IDX                                     = 327,
    SBK_QRhiResourceUpdateBatch_IDX                          = 329,
    SBK_QRhiSampler_Filter_IDX                               = 333,
    SBK_QRhiSampler_AddressMode_IDX                          = 331,
    SBK_QRhiSampler_CompareOp_IDX                            = 332,
    SBK_QRhiSampler_IDX                                      = 330,
    SBK_QRhiScissor_IDX                                      = 334,
    SBK_QRhiShaderResourceBinding_Type_IDX                   = 341,
    SBK_QRhiShaderResourceBinding_StageFlag_IDX              = 339,
    SBK_QFlags_QRhiShaderResourceBinding_StageFlag_IDX       = 103,
    SBK_QRhiShaderResourceBinding_IDX                        = 335,
    SBK_QRhiShaderResourceBinding_Data_IDX                   = 336,
    SBK_QRhiShaderResourceBinding_Data_StorageBufferData_IDX = 337,
    SBK_QRhiShaderResourceBinding_Data_StorageImageData_IDX  = 338,
    SBK_QRhiShaderResourceBinding_TextureAndSampler_IDX      = 340,
    SBK_QRhiShaderResourceBindings_UpdateFlag_IDX            = 343,
    SBK_QFlags_QRhiShaderResourceBindings_UpdateFlag_IDX     = 104,
    SBK_QRhiShaderResourceBindings_IDX                       = 342,
    SBK_QRhiShaderStage_Type_IDX                             = 345,
    SBK_QRhiShaderStage_IDX                                  = 344,
    SBK_QRhiStats_IDX                                        = 346,
    SBK_QRhiSwapChain_Flag_IDX                               = 348,
    SBK_QFlags_QRhiSwapChain_Flag_IDX                        = 105,
    SBK_QRhiSwapChain_Format_IDX                             = 349,
    SBK_QRhiSwapChain_StereoTargetBuffer_IDX                 = 350,
    SBK_QRhiSwapChain_IDX                                    = 347,
    SBK_QRhiSwapChainRenderTarget_IDX                        = 351,
    SBK_QRhiTexture_Flag_IDX                                 = 353,
    SBK_QFlags_QRhiTexture_Flag_IDX                          = 106,
    SBK_QRhiTexture_Format_IDX                               = 354,
    SBK_QRhiTexture_IDX                                      = 352,
    SBK_QRhiTexture_ViewFormat_IDX                           = 355,
    SBK_QRhiTextureCopyDescription_IDX                       = 356,
    SBK_QRhiTextureRenderTarget_Flag_IDX                     = 358,
    SBK_QFlags_QRhiTextureRenderTarget_Flag_IDX              = 107,
    SBK_QRhiTextureRenderTarget_IDX                          = 357,
    SBK_QRhiTextureRenderTargetDescription_IDX               = 359,
    SBK_QRhiTextureSubresourceUploadDescription_IDX          = 360,
    SBK_QRhiTextureUploadDescription_IDX                     = 361,
    SBK_QRhiTextureUploadEntry_IDX                           = 362,
    SBK_QRhiVertexInputAttribute_Format_IDX                  = 364,
    SBK_QRhiVertexInputAttribute_IDX                         = 363,
    SBK_QRhiVertexInputBinding_Classification_IDX            = 366,
    SBK_QRhiVertexInputBinding_IDX                           = 365,
    SBK_QRhiVertexInputLayout_IDX                            = 367,
    SBK_QRhiViewport_IDX                                     = 368,
    SBK_QScreen_IDX                                          = 369,
    SBK_QScrollEvent_ScrollState_IDX                         = 371,
    SBK_QScrollEvent_IDX                                     = 370,
    SBK_QScrollPrepareEvent_IDX                              = 372,
    SBK_QSessionManager_RestartHint_IDX                      = 374,
    SBK_QSessionManager_IDX                                  = 373,
    SBK_QShader_Stage_IDX                                    = 378,
    SBK_QShader_Source_IDX                                   = 377,
    SBK_QShader_Variant_IDX                                  = 379,
    SBK_QShader_SerializedFormatVersion_IDX                  = 376,
    SBK_QShader_IDX                                          = 375,
    SBK_QShaderCode_IDX                                      = 380,
    SBK_QShaderKey_IDX                                       = 381,
    SBK_QShaderVersion_Flag_IDX                              = 383,
    SBK_QFlags_QShaderVersion_Flag_IDX                       = 108,
    SBK_QShaderVersion_IDX                                   = 382,
    SBK_QShortcut_IDX                                        = 384,
    SBK_QShortcutEvent_IDX                                   = 385,
    SBK_QShowEvent_IDX                                       = 386,
    SBK_QSinglePointEvent_IDX                                = 387,
    SBK_QStandardItem_ItemType_IDX                           = 389,
    SBK_QStandardItem_IDX                                    = 388,
    SBK_QStandardItemModel_IDX                               = 390,
    SBK_QStaticText_PerformanceHint_IDX                      = 392,
    SBK_QStaticText_IDX                                      = 391,
    SBK_QStatusTipEvent_IDX                                  = 393,
    SBK_QStyleHints_IDX                                      = 394,
    SBK_QSurface_SurfaceClass_IDX                            = 396,
    SBK_QSurface_SurfaceType_IDX                             = 397,
    SBK_QSurface_IDX                                         = 395,
    SBK_QSurfaceFormat_FormatOption_IDX                      = 400,
    SBK_QFlags_QSurfaceFormat_FormatOption_IDX               = 109,
    SBK_QSurfaceFormat_SwapBehavior_IDX                      = 403,
    SBK_QSurfaceFormat_RenderableType_IDX                    = 402,
    SBK_QSurfaceFormat_OpenGLContextProfile_IDX              = 401,
    SBK_QSurfaceFormat_ColorSpace_IDX                        = 399,
    SBK_QSurfaceFormat_IDX                                   = 398,
    SBK_QSyntaxHighlighter_IDX                               = 404,
    SBK_QTabletEvent_IDX                                     = 405,
    SBK_QTextBlock_IDX                                       = 406,
    SBK_QTextBlock_iterator_IDX                              = 407,
    SBK_QTextBlockFormat_LineHeightTypes_IDX                 = 488,
    SBK_QTextBlockFormat_MarkerType_IDX                      = 409,
    SBK_QTextBlockFormat_IDX                                 = 408,
    SBK_QTextBlockGroup_IDX                                  = 410,
    SBK_QTextBlockUserData_IDX                               = 411,
    SBK_QTextCharFormat_VerticalAlignment_IDX                = 415,
    SBK_QTextCharFormat_UnderlineStyle_IDX                   = 414,
    SBK_QTextCharFormat_FontPropertiesInheritanceBehavior_IDX = 413,
    SBK_QTextCharFormat_IDX                                  = 412,
    SBK_QTextCursor_MoveMode_IDX                             = 417,
    SBK_QTextCursor_MoveOperation_IDX                        = 418,
    SBK_QTextCursor_SelectionType_IDX                        = 419,
    SBK_QTextCursor_IDX                                      = 416,
    SBK_QTextDocument_MetaInformation_IDX                    = 423,
    SBK_QTextDocument_MarkdownFeature_IDX                    = 422,
    SBK_QFlags_QTextDocument_MarkdownFeature_IDX             = 111,
    SBK_QTextDocument_FindFlag_IDX                           = 421,
    SBK_QFlags_QTextDocument_FindFlag_IDX                    = 110,
    SBK_QTextDocument_ResourceType_IDX                       = 424,
    SBK_QTextDocument_Stacks_IDX                             = 425,
    SBK_QTextDocument_IDX                                    = 420,
    SBK_QTextDocumentFragment_IDX                            = 426,
    SBK_QTextDocumentWriter_IDX                              = 427,
    SBK_QTextFormat_FormatType_IDX                           = 429,
    SBK_QTextFormat_Property_IDX                             = 432,
    SBK_QTextFormat_ObjectTypes_IDX                          = 430,
    SBK_QTextFormat_PageBreakFlag_IDX                        = 431,
    SBK_QFlags_QTextFormat_PageBreakFlag_IDX                 = 112,
    SBK_QTextFormat_IDX                                      = 428,
    SBK_QTextFragment_IDX                                    = 433,
    SBK_QTextFrame_IDX                                       = 434,
    SBK_QTextFrame_iterator_IDX                              = 435,
    SBK_QTextFrameFormat_Position_IDX                        = 438,
    SBK_QTextFrameFormat_BorderStyle_IDX                     = 437,
    SBK_QTextFrameFormat_IDX                                 = 436,
    SBK_QTextImageFormat_IDX                                 = 439,
    SBK_QTextInlineObject_IDX                                = 440,
    SBK_QTextItem_RenderFlag_IDX                             = 442,
    SBK_QFlags_QTextItem_RenderFlag_IDX                      = 113,
    SBK_QTextItem_IDX                                        = 441,
    SBK_QTextLayout_GlyphRunRetrievalFlag_IDX                = 446,
    SBK_QFlags_QTextLayout_GlyphRunRetrievalFlag_IDX         = 114,
    SBK_QTextLayout_CursorMode_IDX                           = 444,
    SBK_QTextLayout_IDX                                      = 443,
    SBK_QTextLayout_FormatRange_IDX                          = 445,
    SBK_QTextLength_Type_IDX                                 = 448,
    SBK_QTextLength_IDX                                      = 447,
    SBK_QTextLine_Edge_IDX                                   = 451,
    SBK_QTextLine_CursorPosition_IDX                         = 450,
    SBK_QTextLine_IDX                                        = 449,
    SBK_QTextList_IDX                                        = 452,
    SBK_QTextListFormat_Style_IDX                            = 454,
    SBK_QTextListFormat_IDX                                  = 453,
    SBK_QTextObject_IDX                                      = 455,
    SBK_QTextObjectInterface_IDX                             = 456,
    SBK_QTextOption_TabType_IDX                              = 460,
    SBK_QTextOption_WrapMode_IDX                             = 461,
    SBK_QTextOption_Flag_IDX                                 = 458,
    SBK_QFlags_QTextOption_Flag_IDX                          = 115,
    SBK_QTextOption_IDX                                      = 457,
    SBK_QTextOption_Tab_IDX                                  = 459,
    SBK_QTextTable_IDX                                       = 462,
    SBK_QTextTableCell_IDX                                   = 463,
    SBK_QTextTableCellFormat_IDX                             = 464,
    SBK_QTextTableFormat_IDX                                 = 465,
    SBK_QToolBarChangeEvent_IDX                              = 466,
    SBK_QTouchEvent_IDX                                      = 467,
    SBK_QTransform_TransformationType_IDX                    = 469,
    SBK_QTransform_IDX                                       = 468,
    SBK_QUndoCommand_IDX                                     = 470,
    SBK_QUndoGroup_IDX                                       = 471,
    SBK_QUndoStack_IDX                                       = 472,
    SBK_QValidator_State_IDX                                 = 474,
    SBK_QValidator_IDX                                       = 473,
    SBK_QVector2D_IDX                                        = 475,
    SBK_QVector3D_IDX                                        = 476,
    SBK_QVector4D_IDX                                        = 477,
    SBK_QWhatsThisClickedEvent_IDX                           = 478,
    SBK_QWheelEvent_IDX                                      = 479,
    SBK_QWindow_Visibility_IDX                               = 482,
    SBK_QWindow_AncestorMode_IDX                             = 481,
    SBK_QWindow_IDX                                          = 480,
    SBK_QWindowStateChangeEvent_IDX                          = 483,
    SBK_QtGuiQt_IDX                                          = 484,
    SBK_QtGuiHelper_QOverrideCursorGuard_IDX                 = 486,
    SBK_QtGui_IDX_COUNT                                      = 489,
};
...
enum [[deprecated]] : int {
    ...
    SBK_QTGUI_QLIST_QRHIADAPTERPTR_IDX                       = 21, // QList<QRhiAdapter*>
    SBK_QTGUI_QLIST_QSIZE_IDX                                = 22, // QList<QSize>
    SBK_QTGUI_QLIST_QPOINTF_IDX                              = 23, // QList<QPointF>
    SBK_QTGUI_QLIST_QUINT32_IDX                              = 24, // QList<quint32>
    SBK_QTGUI_QLIST_QFONTDATABASE_WRITINGSYSTEM_IDX          = 25, // QList<QFontDatabase::WritingSystem>
    SBK_QTGUI_QLIST_QPOINT_IDX                               = 26, // QList<QPoint>
    SBK_QTGUI_QLIST_QPOLYGONF_IDX                            = 27, // QList<QPolygonF>
    SBK_QTGUI_QLIST_QPAGERANGES_RANGE_IDX                    = 28, // QList<QPageRanges::Range>
    SBK_QTGUI_QLIST_FLOAT_IDX                                = 29, // QList<float>
    SBK_QTGUI_STD_PAIR_QREAL_QCOLOR_IDX                      = 30, // std::pair<qreal,QColor>
    SBK_QTGUI_QLIST_STD_PAIR_QREAL_QCOLOR_IDX                = 31, // QList<std::pair<qreal,QColor>>
    SBK_QTGUI_QLIST_QSIZETYPE_IDX                            = 32, // QList<qsizetype>
    SBK_QTGUI_QLIST_QFONTVARIABLEAXIS_IDX                    = 33, // QList<QFontVariableAxis>
    SBK_QTGUI_QLIST_QFONT_TAG_IDX                            = 34, // QList<QFont::Tag>
    ...
    SBK_QTGUI_QLIST_QACCESSIBLE_ATTRIBUTE_IDX                = 39, // QList<QAccessible::Attribute>
    SBK_QTGUI_QLIST_UNSIGNEDINT_IDX                          = 40, // QList<unsigned int>
    SBK_QTGUI_QLIST_QLINE_IDX                                = 41, // QList<QLine>
    SBK_QTGUI_QLIST_QLINEF_IDX                               = 42, // QList<QLineF>
    SBK_QTGUI_QLIST_QRECT_IDX                                = 43, // QList<QRect>
    SBK_QTGUI_QLIST_QRECTF_IDX                               = 44, // QList<QRectF>
    SBK_QTGUI_QLIST_QKEYSEQUENCE_IDX                         = 45, // QList<QKeySequence>
    ...
    SBK_QTGUI_QLIST_QOBJECTPTR_IDX                           = 55, // QList<QObject*>
    ...
    SBK_QTGUI_QLIST_QBYTEARRAY_IDX                           = 60, // QList<QByteArray>
    SBK_QTGUI_QLIST_QRHISHADERRESOURCEBINDING_IDX            = 61, // QList<QRhiShaderResourceBinding>
    SBK_QTGUI_QLIST_QRHISHADERSTAGE_IDX                      = 62, // QList<QRhiShaderStage>
    SBK_QTGUI_QLIST_QRHIGRAPHICSPIPELINE_TARGETBLEND_IDX     = 63, // QList<QRhiGraphicsPipeline::TargetBlend>
    SBK_QTGUI_STD_PAIR_INT_UNSIGNEDINT_IDX                   = 64, // std::pair<int,unsigned int>
    SBK_QTGUI_STD_PAIR_QRHIBUFFERPTR_QUINT32_IDX             = 65, // std::pair<QRhiBuffer*,quint32>
    SBK_QTGUI_QLIST_STD_PAIR_QRHIBUFFERPTR_QUINT32_IDX       = 66, // QList<std::pair<QRhiBuffer*,quint32>>
    SBK_QTGUI_STD_PAIR_QRHIBUFFERPTR_UNSIGNEDINT_IDX         = 67, // std::pair<QRhiBuffer*,unsigned int>
    SBK_QTGUI_QLIST_QMODELINDEX_IDX                          = 68, // QList<QModelIndex>
